...
class AtomizationModelWindow(QDialog):
    ...
    def __init__(
        ...
        *,
        nozzle1_type: str = "",
        nozzle1_size=None,
        nozzle1_deflection=None,
        nozzle1_quantity: int = 0,
        nozzle2_type: str = "",
        nozzle2_size=None,
        nozzle2_deflection=None,
        nozzle2_quantity: int = 0,
        pressure_psi: float | None = None,
        airspeed_mph: float | None = None,
        swath_ft: float | None = None,
        gpa: float | None = None,
    ):
        ...
        self._build_ui()
        self._prefill(
            nozzle1_type, nozzle1_size, nozzle1_deflection, nozzle1_quantity,
            nozzle2_type, nozzle2_size, nozzle2_deflection, nozzle2_quantity,
            pressure_psi, airspeed_mph, swath_ft, gpa,
        )
        self._connect()
    ...
    def _prefill(
        ...
        for widget, (t, s, d, q) in zip((self.set1, self.set2), nozzle_args):
            if t:
                widget.populate(t, s, d, q)
